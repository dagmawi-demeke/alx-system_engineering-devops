...
Exercise 19: 0 string SCHOOL  data !:mime Holberton Create a magic file called holberton.mgc that can be used with the command file to detect Holberton data files. Holberton data files always contain "HOLBERTON" at offset 0.
